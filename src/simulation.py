...
from utils import SIMULATION_PARAMS, init_agents, init_lattice, draw_graph, pick_two_random_neighboring_nodes, pick_random_neighboring_node, SimulationResult
...
def simulate():
    ...
    for b in PAYOFFS:
        SIMULATION_RESULTS[b] = SimulationResult(0, 0, 0, 0)

        SIMULATION_PARAMS['b'] = b
        SIMULATION_PARAMS['c'] = b - 1

        for sim_iteration in range(10):
            agents = init_agents()
            ...
            print("Cooperation ratio:", cooperation_ratio)
            ...
            SIMULATION_RESULTS[b].coop_count += total_cooperates
            SIMULATION_RESULTS[b].p_avg
            SIMULATION_RESULTS[b].q_avg
